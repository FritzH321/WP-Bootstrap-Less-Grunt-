 ...
 */
function redbeaver_root_relative_url($input) {
...
if (redbeaver_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'redbeaver_root_relative_url');
}
